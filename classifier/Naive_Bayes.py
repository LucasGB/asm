...
def get_training_data():
	f = open('classifier/training.txt', 'r')
	training_data = []
...
def classify(tweets):
	...
	tweets_data = get_tweets_data(tweets)

	return label_data(tweets_data, sports_word_prob, politics_word_prob, sports_prob, politics_prob)[0][1]